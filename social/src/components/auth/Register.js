...
const Register = ({
  ...
  const { curname, curemail, curphone, curzip, curpassword, conpass, errors } =
    formData;
  ...
  const handleValidation = (e) => {
    ...
    if (
      curname.length == 0 ||
      (curname.length != 0 && !namePat.test(curname))
    ) {
    ...
    if (
      curemail.length == 0 ||
      (curemail.length != 0 && !emailPat.test(curemail))
    ) {
    ...
    if (
      curphone.length == 0 ||
      (curphone.length != 0 && !phonePat.test(curphone))
    ) {
        ...
        <div className="logbox">
          ...
          <form className="form" onSubmit={onSubmit}>
            <div className="form-group">
              <span id="nameWarn" style={{ color: "red" }}>
            ...
            <div className="form-group">
              <span id="emailWarn" style={{ color: "red" }}>
            ...
            <div className="form-group">
              <span id="zipWarn" style={{ color: "red" }}>
                Please check your zip number
              </span>
              <br />
              <input
                className="inputs"
            ...
            <div className="form-group">
              <span id="phoneWarn" style={{ color: "red" }}>
            ...
            <div className="form-group">
              <span id="passwordWarn" style={{ color: "red" }}>
                Password is empty
              </span>
              <br />
              <input
            ...
            <div className="form-group">
              <span id="conpassWarn" style={{ color: "red" }}>
