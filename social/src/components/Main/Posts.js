    ...
    const post = showedData.map((po) => (
        ...
        <Card.Body>
          <Card.Text>
            ...
            <Button className='btn2' variant="outline-secondary" onClick={handleShowCom} >Comment</Button>
          </Card.Text>
        </Card.Body>
        ...
        <div style={{overflowY: 'auto',height:350}}>
          <Table striped>
            <tbody>
              ...
              <tr>
                <td colSpan={2}>Fantanstic article!Multi-layered client-server neural-net</td>
                <td>Antonette</td>
                <td>2022/10/16</td>
              </tr>
            </tbody>
