...
import { checkFriend,updateStatus,addFriends,searchPost,addPost,checkposts,refresh } from '../../actions/posts';
...
const Main = ({updateStatus,checkposts,refresh,addPost,name,status,friends,justReg,searchPost,searchedposts,posts}) => {
...
<div className='nav'>
  <a className='navbar1' style={{display:'inline'}} href="../">  Log Out</a>
  <a  className='navbar2' style={{display:'inline'}} href="../profile">  Profile</a>
</div>

  <Card style={{ width: '18rem' }}>
<Card.Img variant="top" style={{width:100,height:100,marginLeft:80}} src="https://p.qqan.com/up/2021-2/16137992352635419.jpg" />
...
export default connect(mapStateToProps,{ updateStatus,addPost,checkposts,refresh,searchPost })(Main);